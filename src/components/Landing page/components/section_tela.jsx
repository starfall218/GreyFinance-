...
import { applyBorderGlow } from "./borderGlow";
...
function Tela() {
  ...
  useEffect(() => {
    ...
    if (heroButton) {
      const cleanup = applyBorderGlow(heroButton);
      return cleanup;
    }
  }, []);
  ...
  return (
    <>
        {/* Existing Sections */}
        <section className="relative w-full min-h-screen bg-[#1b1f28] flex items-center justify-center py-10 px-4 md:px-8 lg:px-16">
